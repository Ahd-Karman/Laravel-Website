...
<body>
  ...
  <header
    ...
    <div class="col-md-3 text-end">
      <a href="{{ route('logout'); }}"> <button type="button" class="btn btn-outline-light me-2">تسجيل الخروج</button> </a>
      <a href ="{{ route('dashboard'); }}"> <button type="button" class="btn btn-primary me-0" id="showBTN">الملف الشخصي  </button> </a>
    </div>
  </header>
