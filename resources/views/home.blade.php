...
<body>
  ...
  <header
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      <li><a href="#" class="nav-link px-2 link-secondary" style="border-bottom: 3px solid #007bff;" > الرئيسية</a></li>
      <li><a href="Jobs.html" class="nav-link px-2 link-light">الوظائف </a></li>
      <li><a href="services.html" class="nav-link px-2 link-light">خدماتنا</a></li>
      <li><a href="#" class="nav-link px-2 link-light">الشركاء</a></li>
      <li><a href="#" class="nav-link px-2 link-light">من نحن </a></li>
      <li><a href="#" class="nav-link px-2 link-light">تواصل معنا</a></li>
    </ul>

    <div class="col-md-3 text-end">
      <a href="login.html"> <button type="button" class="btn btn-outline-light me-2">تسجيل الدخول</button> </a>
      <a href="signup.html" > <button class="btn btn-primary me-0" id="showBTN">إنشاء حساب </button> </a>
    </div>
  </header>
